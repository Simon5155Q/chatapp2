...
def chatWindow():
    ...
    disconnect = Button(window, text="Disconnect", font=("Arial", 13))
...
def receivemsg():
    ...
    while True:
        try:
            ...
            print(details)
            if("tiul" in details.decode()):
                namelist = details.decode().split(",")
                print(namelist)
                print(details)
                listbox.insert(namelist[0],namelist[0] + ":" + namelist[1] + ":" + namelist[3] + " " + namelist[5])
                print(namelist[0],namelist[0] + ":" + namelist[1] + ":" + namelist[3] + " " + namelist[5])
            else:
